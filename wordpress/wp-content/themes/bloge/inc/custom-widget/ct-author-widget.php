 ...
 * @since 1.0.0
 */
class Bloge_Author_Widget extends WP_Widget{
     public function __construct(){
          parent::__construct(
               'bloge-author-widget',
               __( 'CT Author', 'bloge' ),
               array( 'description' => __( 'Place anywhere in the Widget area.', 'bloge' ) )
          );
     }   
     ...
     public function form($instance ){
          ?>
          <p>
              <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Author or Ads Title', 'bloge' ); ?></label><br />
            ...
            <p>
              ...
              <p>
                 ...
                 <input type="text" class="widefat custom_media_url" name="<?php echo $this->get_field_name('image_uri'); ?>" id="<?php echo $this->get_field_id('image_uri'); ?>" value="<?php 
                  ...
                  ?>">
                 <input type="button" class="button button-primary custom_media_button" id="custom_media_button" name="<?php echo $this->get_field_name('image_uri'); ?>" value="<?php esc_attr_e('Upload Image','bloge')?>" />
             </p>
             <p>
                <label for="<?php echo esc_attr( $this->get_field_id('facebook') ); ?>"><?php _e( 'Facebook', 'bloge' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('twitter') ); ?>"><?php _e( 'Twitter', 'bloge' ); ?></label><br />
         ...
         <p>
                <label for="<?php echo esc_attr( $this->get_field_id('googleplus') ); ?>"><?php _e( 'Google Plus', 'bloge' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('instagram') ); ?>"><?php _e( 'Instagram', 'bloge' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('linkedin') ); ?>"><?php _e( 'Linkedin', 'bloge' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('youtube') ); ?>"><?php _e( 'Youtube', 'bloge' ); ?></label><br />
...
add_action( 'widgets_init', 'bloge_author_widget' ); 
function bloge_author_widget(){     
